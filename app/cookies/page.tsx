          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6 md:p-8">
              <div className="space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
                <p>
                  En poursuivant votre navigation sur MonHubimmo, vous acceptez l&apos;utilisation de cookies nécessaires au bon fonctionnement du site.
                </p>
                
                <p>
                  Vous pouvez toutefois paramétrer vos préférences à tout moment via notre bandeau de gestion des cookies.
                </p>
                
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                  <p className="text-blue-700">
                    Pour en savoir plus sur l&apos;utilisation de vos données et vos droits, consultez notre{" "}
                    <a 
